        ...
        if (VSVersion >= 12.0)
        {
            ...
            for (var i = 0; i < astrPlatforms.length; i++)
            {
                for (var j = 0; j < astrConfigName.length; j++)
                {
                    ...
                    oStream.WriteLine("    <Import Project=\"$(LocalAppData)\\Microsoft\\VisualStudio\\12.0\\Microsoft.Cpp.$(Platform).user.props\" Condition=\"exists('$(LocalAppData)\\Microsoft\\VisualStudio\\12.0\\Microsoft.Cpp.$(Platform).user.props')\" />");
                    oStream.WriteLine("  </ImportGroup>");
                    oStream.WriteLine();
                }
            }
